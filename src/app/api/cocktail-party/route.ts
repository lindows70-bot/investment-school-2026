...
function getStatus(score: number): CocktailPartyResult['status'] {
  ...
  return {
    ...
    // ⚠️ 이 문장들은 린치의 **실제 발언 인용이 아니라 칵테일파티 이론의 재구성**이다(2026-08-30 감사).
    //    따옴표+귀속으로 쓰면 허위 인용이 되므로 간접 서술로 바꾼다.
    lynchQuote: '피터 린치의 칵테일파티 이론 4단계 — 모르는 사람까지 종목을 추천하는 국면을 시장 과열의 신호로 봤습니다.',
  }
}
