...
const LYNCH_KR: Record<string, { lynchLabel: string; sector: string }> = {
  ...
  '207940': { lynchLabel: '고성장주', sector: '바이오' },
  '068270': { lynchLabel: '고성장주', sector: '바이오' },
  '105560': { lynchLabel: '경기순환주', sector: '금융/은행' },
  '055550': { lynchLabel: '경기순환주', sector: '금융/은행' },
  '035420': { lynchLabel: '고성장주', sector: '인터넷' },
  '005490': { lynchLabel: '경기순환주', sector: '철강' },
  '012450': { lynchLabel: '고성장주', sector: '방산/항공' },
...
const LYNCH_US: Record<string, { lynchLabel: string; sector: string }> = {
  'NVDA': { lynchLabel: '고성장주', sector: '반도체' },
  'AAPL': { lynchLabel: '대형우량주', sector: '소비자전자' },
  'MSFT': { lynchLabel: '대형우량주', sector: '소프트웨어' },
  'GOOGL': { lynchLabel: '고성장주', sector: '광고/AI' },
  'AMZN': { lynchLabel: '고성장주', sector: '커머스/클라우드' },
  'META': { lynchLabel: '고성장주', sector: '소셜미디어' },
  'AVGO': { lynchLabel: '고성장주', sector: '반도체' },
  'TSLA': { lynchLabel: '고성장주', sector: '전기차' },
  'BRK-B': { lynchLabel: '대형우량주', sector: '금융지주' },
  'JPM': { lynchLabel: '대형우량주', sector: '금융/은행' },
  'WMT': { lynchLabel: '대형우량주', sector: '유통' },
  'LLY': { lynchLabel: '고성장주', sector: '제약/비만치료' },
  ...
  'NFLX': { lynchLabel: '고성장주', sector: '스트리밍' },
  'ORCL': { lynchLabel: '대형우량주', sector: '소프트웨어' },
  'AMD': { lynchLabel: '고성장주', sector: '반도체' },
  'ASML': { lynchLabel: '고성장주', sector: '반도체장비' },
  'TSM': { lynchLabel: '경기순환주', sector: '반도체 파운드리' },
  'SPCX': { lynchLabel: '고성장주', sector: '우주항공/위성' },   // SpaceX — 2026 상장, 시총 $2T+ 진입
  'CRM': { lynchLabel: '고성장주', sector: '클라우드SaaS' },
