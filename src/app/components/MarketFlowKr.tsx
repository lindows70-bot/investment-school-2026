  ...
  return (
    <div style={{ background: CARD, borderRadius: 12, padding: '16px 18px', border: `1px solid ${BORDER}` }}>
      ...
      {heat && (
        <div style={{ overflowX: 'auto' }}>
          <div style={{ color: '#7f93a8', fontSize: 10.5, marginBottom: 8, lineHeight: 1.6 }}>
            {TABS.find(t => t.key === view)!.label} 종목의 <b style={{ color: '#cbd5e1' }}>추세속도(MA10 이격도 %)</b> 최근 5거래일 — 🔴빨강=상승추세·🔵파랑=하락추세, 짙을수록 강함. 5일 흐름으로 <b style={{ color: '#cbd5e1' }}>가속/둔화/전환</b>을 봅니다.
          </div>
      ...
      <div style={{ color: '#6e7f8f', fontSize: 10, marginTop: 10, lineHeight: 1.5 }}>
        {heat
          ? '※ 추세속도 = (종가−10일 이동평균)/이동평균×100(이격도) · 부호=추세방향·크기=강도·5일변화=가속/둔화 · 머니디자인式 추세속도의 교육용 근사(독자지표와 공식 다름) · 투자 추천 아님.'
