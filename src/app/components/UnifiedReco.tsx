  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div style={{ color: '#9aa7b5', fontSize: 10.5, lineHeight: 1.6 }}>
        ※ 통합 점수 = 계절 적합(현재 매크로 계절의 우대 섹터/분류) + 펀더멘탈 가치(린치가중·PEG·영업이익률·FCF) + 수급(연료). 최종 선별된 종목은 🛡️ <b>버핏 DCF 안전마진</b>(내재가치 대비 저평가율)·📈 <b>Fwd EPS 이익추정 모멘텀</b>(애널리스트 상·하향)으로 추가 심화 검증해 배지로 표시합니다. <b>수급*</b>는 미국 종목으로, 외국인/기관 실수급이 없어 MFI·내부자·13F 거인 <b>프록시</b>입니다(한국은 외인/기관/개인 실수급). PEG는 stock-info SSOT 기준. 보유 종목은 제외했습니다. 교육용 시뮬레이션이며 투자 추천이 아닙니다.
      </div>
    </div>
  )
}
