    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background: N,
            boxShadow: `0 0 0 1px ${TK.line2}, 12px 12px 32px #0a0c18, -6px -6px 20px ${TK.line2}`,
            borderRadius: 18,
            maxWidth: 480,
            width: '100%',
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 22 }}>
            {(['buy', 'sell'] as const).map(m => {
              ...
              const activeColor = m === 'buy' ? TK.red500 : TK.blue500
              return (
                <button
                  key={m}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div>
              {mode === 'buy' ? (
                ...
                <>
                  ...
                  <label style={labelStyle}>
                    매도 체결가
                    <span style={{ color: TK.blue500, marginLeft: 4 }}>*</span>
                  </label>
                </>
              )}
              ...
              {/* 매수 모드 가이드 텍스트 */}
              {mode === 'buy' && (
                <p style={{ ...hintStyle, color: TK.sub4 }}>
            ...
            <div>
              <label style={{ ...labelStyle, display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                {mode === 'sell' && (
                  <>
                    <span style={{ color: TK.blue500, fontWeight: 400, textTransform: 'none' }}>
          ...
          <div style={{ background: TK.bg0, boxShadow: SHI, borderRadius: 10, padding: '14px 16px', marginTop: 20, fontSize: 13, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            {mode === 'buy' && buyCalc && (
              <>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: TK.sub4 }}>이번 거래금액</span>
                  <span style={{ color: TK.sub12, fontWeight: 600, fontVariantNumeric: 'tabular-nums' }}>
                    {currSym}{formatNum(buyCalc.totalAmt, investment.currency === 'KRW' ? 0 : 2)}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: TK.sub4 }}>거래 후 평단가</span>
                  <span style={{ color: TK.amber400, fontWeight: 600, fontVariantNumeric: 'tabular-nums' }}>
                    {currSym}{formatNum(buyCalc.newAvg, investment.currency === 'KRW' ? 0 : 2)}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: TK.sub4 }}>거래 후 총 보유수량</span>
                  <span style={{ color: TK.sub12, fontWeight: 600 }}>
            ...
            {mode === 'sell' && sellCalc && (
              <>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: TK.sub4 }}>매도 체결가</span>
                  <span style={{ color: TK.sub12, fontWeight: 600, fontVariantNumeric: 'tabular-nums' }}>
                    {currSym}{formatNum(priceNum, investment.currency === 'KRW' ? 0 : 2)}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: TK.sub4 }}>매도 총액</span>
                  <span style={{ color: TK.sub12, fontWeight: 600, fontVariantNumeric: 'tabular-nums' }}>
                    {currSym}{formatNum(sellCalc.totalAmt, investment.currency === 'KRW' ? 0 : 2)}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: TK.sub4 }}>실현 손익</span>
                  <span style={{
                    fontWeight: 700, fontVariantNumeric: 'tabular-nums',
                    color: sellCalc.pnl > 0 ? TK.red500 : sellCalc.pnl < 0 ? TK.blue500 : TK.sub12,
                  }}>
                    {sellCalc.pnl >= 0 ? '+' : ''}{currSym}{formatNum(Math.abs(sellCalc.pnl), investment.currency === 'KRW' ? 0 : 2)}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: TK.sub4 }}>매도 후 잔여수량</span>
                  <span style={{ color: TK.sub12, fontWeight: 600 }}>
