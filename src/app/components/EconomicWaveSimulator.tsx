      ...
      {eduOpen && (
        <div style={{ color: '#aab6c4', fontSize: 11, lineHeight: 1.65, marginTop: 6, display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          <div style={{ background: 'rgba(96,165,250,0.07)', border: '1px solid rgba(96,165,250,0.25)', borderRadius: 8, padding: '8px 11px' }}>
            🧭 <b style={{ color: '#93c5fd' }}>핵심</b> — 4계절 내비게이터는 <b>단·중기 파동(키친·주글라르)</b>을 측정합니다. 그런데 지금 시장은 <b>콘드라티예프 상승 파동(AI)</b>이라는 거대한 해일 위에 있어, &ldquo;여름이라 기술주 불리&rdquo;라는 교과서를 무시하고 오릅니다. <b>괴리는 버그가 아니라, 측정 중인 파동보다 더 큰 파동이 시장을 끌고 가고 있다는 신호</b>입니다.
          </div>
