      ...
      <div style={{ background: `linear-gradient(160deg, ${TK.green400}0c, ${TK.bg3} 55%)`, border: `1px solid ${TK.green400}33`, borderRadius: 13, padding: '14px 16px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {[
            ...
            // 🔗 "리서치로 확인하라"고 글로만 안내하고 정작 링크가 없었다 — 안내는 갈 수 있어야 안내다(2026-08-08)
            { i: '✅', c: TK.amber400, t: <>매수 전엔 <a href="/research" style={{ color: TK.amber400, fontWeight: 800 }}>종목 리서치 →</a> 의 <b>‘🎯 종합 매수 판정’</b>으로 그 종목 하나를 다시 확인(6축+기술 타이밍). 각 추천 화면의 종목 카드에 붙은 <b>🎯 종합 판정</b> 칩을 눌러도 바로 갑니다.</> },
          ].map((r, k) => (
