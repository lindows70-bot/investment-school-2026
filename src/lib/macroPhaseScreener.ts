...
const US_UNIVERSE: { ticker: string; lynch: LynchCategory; name: string }[] = [
  ...
  { ticker:'GIS', lynch:'stalwart',    name:'General Mills' },
  { ticker:'HSY', lynch:'stalwart',    name:'The Hershey' },
  { ticker:'STZ', lynch:'stalwart',    name:'Constellation Brands' },
  { ticker:'KHC', lynch:'stalwart',    name:'The Kraft Heinz' },
  { ticker:'MDLZ', lynch:'stalwart',    name:'Mondelez International' },
  { ticker:'KDP', lynch:'stalwart',    name:'Keurig Dr Pepper' },
  { ticker:'MNST', lynch:'stalwart',    name:'Monster Beverage' },
  { ticker:'CHD', lynch:'stalwart',    name:'Church & Dwight Company' },
  { ticker:'CLX', lynch:'stalwart',    name:'Clorox Company (The)' },
  { ticker:'SYY', lynch:'stalwart',    name:'Sysco' },
  { ticker:'ADM', lynch:'stalwart',    name:'Archer-Daniels-Midland' },
  { ticker:'KR', lynch:'stalwart',    name:'Kroger Company (The)' },
  { ticker:'DG', lynch:'stalwart',    name:'Dollar General' },
  { ticker:'DLTR', lynch:'stalwart',    name:'Dollar Tree' },
  { ticker:'TAP', lynch:'stalwart',    name:'Molson Coors Beverage' },
  { ticker:'HRL', lynch:'stalwart',    name:'Hormel Foods' },
  { ticker:'CAG', lynch:'stalwart',    name:'ConAgra Brands' },
  { ticker:'MKC', lynch:'stalwart',    name:'McCormick & Company' },
  { ticker:'KVUE', lynch:'stalwart',    name:'Kenvue' },
  { ticker:'AON', lynch:'stalwart',    name:'Aon' },
  { ticker:'AJG', lynch:'stalwart',    name:'Arthur J. Gallagher &' },
  { ticker:'TRV', lynch:'stalwart',    name:'The Travelers Companies' },
  { ticker:'ZTS', lynch:'stalwart',    name:'Zoetis' },
  { ticker:'IDXX', lynch:'stalwart',    name:'IDEXX Laboratories' },
  { ticker:'RMD', lynch:'stalwart',    name:'ResMed' },
  { ticker:'IQV', lynch:'stalwart',    name:'IQVIA Holdings' },
  { ticker:'VEEV', lynch:'stalwart',    name:'Veeva Systems' },
  { ticker:'MCO', lynch:'stalwart',    name:'Moodys' },
  { ticker:'MSCI', lynch:'stalwart',    name:'MSCI' },
  { ticker:'WTW', lynch:'stalwart',    name:'Willis Towers Watson Public Lim' },
  { ticker:'BRO', lynch:'stalwart',    name:'Brown & Brown' },
  { ticker:'CTAS', lynch:'stalwart',    name:'Cintas' },
  { ticker:'ROP', lynch:'stalwart',    name:'Roper Technologies' },
  { ticker:'AME', lynch:'stalwart',    name:'AMETEK' },
  { ticker:'VRSK', lynch:'stalwart',    name:'Verisk Analytics' },
  { ticker:'EFX', lynch:'stalwart',    name:'Equifax' },
  { ticker:'FAST', lynch:'stalwart',    name:'Fastenal' },
  { ticker:'PAYX', lynch:'stalwart',    name:'Paychex' },
  { ticker:'ODFL', lynch:'stalwart',    name:'Old Dominion Freight Line' },
  { ticker:'GWW', lynch:'stalwart',    name:'W.W. Grainger' },
  { ticker:'ITW', lynch:'stalwart',    name:'Illinois Tool Works' },
  { ticker:'TT', lynch:'stalwart',    name:'Trane Technologies' },
  { ticker:'ROK', lynch:'stalwart',    name:'Rockwell Automation' },
  { ticker:'DOV', lynch:'stalwart',    name:'Dover' },
  { ticker:'FTV', lynch:'stalwart',    name:'Fortive' },
  { ticker:'IR', lynch:'stalwart',    name:'Ingersoll Rand' },
  { ticker:'TDY', lynch:'stalwart',    name:'Teledyne Technologies Incorpora' },
  { ticker:'LIN', lynch:'stalwart',    name:'Linde' },
  { ticker:'APD', lynch:'stalwart',    name:'Air Products and Chemicals' },
  { ticker:'SHW', lynch:'stalwart',    name:'Sherwin-Williams Company (The)' },
  { ticker:'ECL', lynch:'stalwart',    name:'Ecolab' },
  ...
  { ticker:'SRE', lynch:'stalwart',    name:'DBA Sempra' },
  { ticker:'PEG', lynch:'stalwart',    name:'Public Service Enterprise' },
  { ticker:'ED', lynch:'stalwart',    name:'Consolidated Edison' },
  { ticker:'WEC', lynch:'stalwart',    name:'WEC Energy Group' },
  { ticker:'ES', lynch:'stalwart',    name:'Eversource Energy (D/B/A)' },
  { ticker:'DTE', lynch:'stalwart',    name:'DTE Energy' },
  { ticker:'AEE', lynch:'stalwart',    name:'Ameren' },
  { ticker:'PPL', lynch:'stalwart',    name:'PPL' },
  { ticker:'FE', lynch:'stalwart',    name:'FirstEnergy' },
  { ticker:'CMS', lynch:'stalwart',    name:'CMS Energy' },
  { ticker:'ATO', lynch:'stalwart',    name:'Atmos Energy' },
  { ticker:'CPRT', lynch:'stalwart',    name:'Copart' },
  { ticker:'FICO', lynch:'stalwart',    name:'Fair Isaac' },
  { ticker:'TYL', lynch:'stalwart',    name:'Tyler Technologies' },
  { ticker:'PTC', lynch:'stalwart',    name:'PTC' },
  { ticker:'IT', lynch:'stalwart',    name:'Gartner' },
  { ticker:'CTSH', lynch:'stalwart',    name:'Cognizant Technology Solutions' },
  { ticker:'ACGL', lynch:'stalwart',    name:'Arch Capital Group' },
  { ticker:'WST', lynch:'stalwart',    name:'West Pharmaceutical Services' },
  { ticker:'MTD', lynch:'stalwart',    name:'Mettler-Toledo International' },
  { ticker:'A', lynch:'stalwart',    name:'Agilent Technologies' },
  { ticker:'DGX', lynch:'stalwart',    name:'Quest Diagnostics Incorporated' },
  { ticker:'FTNT', lynch:'fast_grower', name:'Fortinet' },
  { ticker:'WDAY', lynch:'fast_grower', name:'Workday' },
  { ticker:'TEAM', lynch:'fast_grower', name:'Atlassian' },
  { ticker:'HUBS', lynch:'fast_grower', name:'HubSpot' },
  { ticker:'ZM', lynch:'fast_grower', name:'Zoom Communications' },
  { ticker:'DOCU', lynch:'fast_grower', name:'DocuSign' },
  { ticker:'OKTA', lynch:'fast_grower', name:'Okta' },
  { ticker:'MDB', lynch:'fast_grower', name:'MongoDB' },
  { ticker:'TWLO', lynch:'fast_grower', name:'Twilio' },
  { ticker:'NTNX', lynch:'fast_grower', name:'Nutanix' },
  { ticker:'GTLB', lynch:'fast_grower', name:'GitLab' },
  { ticker:'S', lynch:'fast_grower', name:'SentinelOne' },
  ...
  { ticker:'ROKU', lynch:'fast_grower', name:'Roku' },
  { ticker:'DASH', lynch:'fast_grower', name:'DoorDash' },
  { ticker:'GEHC', lynch:'fast_grower', name:'GE HealthCare Technologies' },
  { ticker:'DXCM', lynch:'fast_grower', name:'DexCom' },
  { ticker:'ALGN', lynch:'fast_grower', name:'Align Technology' },
  { ticker:'PODD', lynch:'fast_grower', name:'Insulet' },
  { ticker:'MRNA', lynch:'fast_grower', name:'Moderna' },
  { ticker:'BIIB', lynch:'fast_grower', name:'Biogen' },
  { ticker:'TECH', lynch:'fast_grower', name:'Bio-Techne' },
  { ticker:'INCY', lynch:'fast_grower', name:'Incyte' },
  { ticker:'MELI', lynch:'fast_grower', name:'MercadoLibre' },
  { ticker:'SE', lynch:'fast_grower', name:'Sea Limited' },
  { ticker:'NU', lynch:'fast_grower', name:'Nu Holdings' },
  { ticker:'GRAB', lynch:'fast_grower', name:'Grab Holdings Limited' },
  { ticker:'ETSY', lynch:'fast_grower', name:'Etsy' },
  { ticker:'W', lynch:'fast_grower', name:'Wayfair' },
  { ticker:'ULTA', lynch:'fast_grower', name:'Ulta Beauty' },
  { ticker:'CELH', lynch:'fast_grower', name:'Celsius Holdings' },
  { ticker:'DECK', lynch:'fast_grower', name:'Deckers Outdoor' },
  { ticker:'AXON', lynch:'fast_grower', name:'Axon Enterprise' },
  { ticker:'PWR', lynch:'fast_grower', name:'Quanta Services' },
  { ticker:'URI', lynch:'fast_grower', name:'United Rentals' },
  { ticker:'TDG', lynch:'fast_grower', name:'Transdigm Group Incorporated' },
  { ticker:'EPAM', lynch:'fast_grower', name:'EPAM Systems' },
  { ticker:'ZBRA', lynch:'fast_grower', name:'Zebra Technologies' },
  { ticker:'TRMB', lynch:'fast_grower', name:'Trimble' },
  { ticker:'GEN', lynch:'fast_grower', name:'Gen Digital' },
  { ticker:'CRDO', lynch:'fast_grower', name:'Credo Technology Group Holding' },
  { ticker:'ALAB', lynch:'fast_grower', name:'Astera Labs' },
  { ticker:'NVMI', lynch:'fast_grower', name:'Nova' },
  ...
  { ticker:'QRVO', lynch:'fast_grower', name:'Qorvo' },
  { ticker:'ENTG', lynch:'fast_grower', name:'Entegris' },
  { ticker:'POWI', lynch:'fast_grower', name:'Power Integrations' },
  ...
  { ticker:'YUM', lynch:'cyclical',    name:'Yum! Brands' },
  { ticker:'MAR', lynch:'cyclical',    name:'Marriott International' },
  { ticker:'HLT', lynch:'cyclical',    name:'Hilton Worldwide Holdings' },
  { ticker:'RCL', lynch:'cyclical',    name:'Royal Caribbean Cruises' },
  { ticker:'CCL', lynch:'cyclical',    name:'Carnival Corporation' },
  { ticker:'NCLH', lynch:'cyclical',    name:'Norwegian Cruise Line Holdings' },
  { ticker:'GM', lynch:'cyclical',    name:'General Motors' },
  { ticker:'F', lynch:'cyclical',    name:'Ford Motor' },
  { ticker:'APTV', lynch:'cyclical',    name:'Aptiv' },
  { ticker:'LEN', lynch:'cyclical',    name:'Lennar' },
  { ticker:'DHI', lynch:'cyclical',    name:'D.R. Horton' },
  { ticker:'NVR', lynch:'cyclical',    name:'NVR' },
  { ticker:'PHM', lynch:'cyclical',    name:'PulteGroup' },
  { ticker:'EBAY', lynch:'cyclical',    name:'eBay' },
  { ticker:'DPZ', lynch:'cyclical',    name:'Dominos Pizza' },
  { ticker:'DRI', lynch:'cyclical',    name:'Darden Restaurants' },
  { ticker:'BBY', lynch:'cyclical',    name:'Best Buy Co.' },
  { ticker:'TSCO', lynch:'cyclical',    name:'Tractor Supply' },
  { ticker:'GRMN', lynch:'cyclical',    name:'Garmin' },
  { ticker:'POOL', lynch:'cyclical',    name:'Pool' },
  { ticker:'WHR', lynch:'cyclical',    name:'Whirlpool' },
  { ticker:'LVS', lynch:'cyclical',    name:'Las Vegas Sands' },
  { ticker:'WYNN', lynch:'cyclical',    name:'Wynn Resorts' },
  { ticker:'MGM', lynch:'cyclical',    name:'MGM Resorts International' },
  { ticker:'EXPE', lynch:'cyclical',    name:'Expedia Group' },
  { ticker:'RL', lynch:'cyclical',    name:'Ralph Lauren' },
  { ticker:'TPR', lynch:'cyclical',    name:'Tapestry' },
  { ticker:'GPC', lynch:'cyclical',    name:'Genuine Parts' },
  { ticker:'KMX', lynch:'cyclical',    name:'CarMax' },
  { ticker:'MMM', lynch:'cyclical',    name:'3M' },
  { ticker:'GD', lynch:'cyclical',    name:'General Dynamics' },
  { ticker:'PH', lynch:'cyclical',    name:'Parker-Hannifin' },
  { ticker:'JCI', lynch:'cyclical',    name:'Johnson Controls International' },
  { ticker:'CMI', lynch:'cyclical',    name:'Cummins' },
  { ticker:'CSX', lynch:'cyclical',    name:'CSX' },
  { ticker:'NSC', lynch:'cyclical',    name:'Norfolk Southern' },
  { ticker:'FDX', lynch:'cyclical',    name:'FedEx' },
  { ticker:'WM', lynch:'cyclical',    name:'Waste Management' },
  { ticker:'RSG', lynch:'cyclical',    name:'Republic Services' },
  { ticker:'HWM', lynch:'cyclical',    name:'Howmet Aerospace' },
  { ticker:'HUBB', lynch:'cyclical',    name:'Hubbell' },
  { ticker:'GNRC', lynch:'cyclical',    name:'Generac Holdlings' },
  { ticker:'BLDR', lynch:'cyclical',    name:'Builders FirstSource' },
  { ticker:'MAS', lynch:'cyclical',    name:'Masco' },
  { ticker:'PCAR', lynch:'cyclical',    name:'PACCAR' },
  { ticker:'PNR', lynch:'cyclical',    name:'Pentair' },
  { ticker:'ALLE', lynch:'cyclical',    name:'Allegion' },
  { ticker:'JBHT', lynch:'cyclical',    name:'J.B. Hunt Transport Services' },
  { ticker:'EXPD', lynch:'cyclical',    name:'Expeditors International of Was' },
  { ticker:'CHRW', lynch:'cyclical',    name:'C.H. Robinson Worldwide' },
  { ticker:'SNA', lynch:'cyclical',    name:'Snap-On Incorporated' },
  { ticker:'SWK', lynch:'cyclical',    name:'Stanley Black & Decker' },
  { ticker:'DAL', lynch:'cyclical',    name:'Delta Air Lines' },
  { ticker:'UAL', lynch:'cyclical',    name:'United Airlines Holdings' },
...
const KR_UNIVERSE: { ticker: string; lynch: LynchCategory; name: string }[] = [
  ...
  { ticker:'004370', lynch:'stalwart',    name:'농심' },
  { ticker:'280360', lynch:'stalwart',    name:'롯데웰푸드' },
  { ticker:'007310', lynch:'stalwart',    name:'오뚜기' },
  { ticker:'005300', lynch:'stalwart',    name:'롯데칠성' },
  { ticker:'000080', lynch:'stalwart',    name:'하이트진로' },
  { ticker:'003230', lynch:'stalwart',    name:'삼양식품' },
  { ticker:'026960', lynch:'stalwart',    name:'동서' },
  { ticker:'004990', lynch:'stalwart',    name:'롯데지주' },
  { ticker:'002790', lynch:'stalwart',    name:'아모레퍼시픽홀딩스' },
  { ticker:'161890', lynch:'stalwart',    name:'한국콜마' },
  { ticker:'192820', lynch:'stalwart',    name:'코스맥스' },
  { ticker:'237880', lynch:'stalwart',    name:'클리오' },
  { ticker:'007070', lynch:'stalwart',    name:'GS리테일' },
  { ticker:'023530', lynch:'stalwart',    name:'롯데쇼핑' },
  { ticker:'069960', lynch:'stalwart',    name:'현대백화점' },
  { ticker:'004170', lynch:'stalwart',    name:'신세계' },
  { ticker:'057050', lynch:'stalwart',    name:'현대홈쇼핑' },
  { ticker:'069620', lynch:'fast_grower', name:'대웅제약' },
  { ticker:'000250', lynch:'fast_grower', name:'삼천당제약' },
  { ticker:'302440', lynch:'fast_grower', name:'SK바이오사이언스' },
  { ticker:'145720', lynch:'fast_grower', name:'덴티움' },
  { ticker:'328130', lynch:'fast_grower', name:'루닛' },
  { ticker:'095700', lynch:'fast_grower', name:'제넥신' },
  { ticker:'085660', lynch:'fast_grower', name:'차바이오텍' },
  { ticker:'263750', lynch:'fast_grower', name:'펄어비스' },
  { ticker:'293490', lynch:'fast_grower', name:'카카오게임즈' },
  { ticker:'112040', lynch:'fast_grower', name:'위메이드' },
  { ticker:'078340', lynch:'fast_grower', name:'컴투스' },
  { ticker:'194480', lynch:'fast_grower', name:'데브시스터즈' },
  { ticker:'035900', lynch:'fast_grower', name:'JYP Ent.' },
  { ticker:'041510', lynch:'fast_grower', name:'에스엠' },
  { ticker:'122870', lynch:'fast_grower', name:'와이지엔터테인먼트' },
  { ticker:'376300', lynch:'fast_grower', name:'디어유' },
  { ticker:'066970', lynch:'fast_grower', name:'엘앤에프' },
  { ticker:'137400', lynch:'fast_grower', name:'피엔티' },
  { ticker:'020150', lynch:'fast_grower', name:'롯데에너지머티리얼즈' },
  { ticker:'121600', lynch:'fast_grower', name:'나노신소재' },
  { ticker:'108320', lynch:'fast_grower', name:'LX세미콘' },
  { ticker:'088390', lynch:'fast_grower', name:'이녹스' },
  { ticker:'178320', lynch:'fast_grower', name:'서진시스템' },
  { ticker:'285130', lynch:'fast_grower', name:'SK케미칼' },
  { ticker:'120110', lynch:'fast_grower', name:'코오롱인더' },
  { ticker:'108860', lynch:'fast_grower', name:'셀바스AI' },
  { ticker:'376980', lynch:'fast_grower', name:'원티드랩' },
  { ticker:'204320', lynch:'cyclical',    name:'HL만도' },
  { ticker:'011210', lynch:'cyclical',    name:'현대위아' },
  { ticker:'018880', lynch:'cyclical',    name:'한온시스템' },
  { ticker:'267250', lynch:'cyclical',    name:'HD현대' },
  { ticker:'241560', lynch:'cyclical',    name:'두산밥캣' },
  { ticker:'272210', lynch:'cyclical',    name:'한화시스템' },
  ...
  { ticker:'078930', lynch:'cyclical',    name:'GS' },
  { ticker:'006360', lynch:'cyclical',    name:'GS건설' },
  { ticker:'000720', lynch:'cyclical',    name:'현대건설' },
  { ticker:'047040', lynch:'cyclical',    name:'대우건설' },
  { ticker:'028050', lynch:'cyclical',    name:'삼성E&A' },
  { ticker:'375500', lynch:'cyclical',    name:'DL이앤씨' },
  { ticker:'294870', lynch:'cyclical',    name:'IPARK현대산업개발' },
  { ticker:'090460', lynch:'cyclical',    name:'비에이치' },
  { ticker:'095610', lynch:'cyclical',    name:'테스' },
  { ticker:'067310', lynch:'cyclical',    name:'하나마이크론' },
  { ticker:'046890', lynch:'cyclical',    name:'서울반도체' },
  { ticker:'000990', lynch:'cyclical',    name:'DB하이텍' },
  { ticker:'004000', lynch:'cyclical',    name:'롯데정밀화학' },
  { ticker:'001120', lynch:'cyclical',    name:'LX인터내셔널' },
  { ticker:'001680', lynch:'stalwart',    name:'대상' },
  { ticker:'001800', lynch:'stalwart',    name:'오리온홀딩스' },
  { ticker:'005180', lynch:'stalwart',    name:'빙그레' },
  { ticker:'336260', lynch:'fast_grower', name:'두산퓨얼셀' },
  { ticker:'336370', lynch:'fast_grower', name:'솔루스첨단소재' },
  { ticker:'214420', lynch:'fast_grower', name:'토니모리' },
  { ticker:'950130', lynch:'fast_grower', name:'엑세스바이오' },
  { ticker:'214370', lynch:'fast_grower', name:'케어젠' },
  { ticker:'042000', lynch:'fast_grower', name:'카페24' },
  { ticker:'067160', lynch:'fast_grower', name:'SOOP' },
  { ticker:'393890', lynch:'fast_grower', name:'더블유씨피' },
  { ticker:'225570', lynch:'fast_grower', name:'넥슨게임즈' },
  { ticker:'099320', lynch:'fast_grower', name:'쎄트렉아이' },
  { ticker:'950210', lynch:'fast_grower', name:'프레스티지바이오파마' },
  { ticker:'235980', lynch:'fast_grower', name:'메드팩토' },
...
async function screenOne(
  ...
  try {
    ...
    // 💵 분자는 현금흐름표에서 직접(OCF−CapEx) — financialData.freeCashflow 는 정의 불명이다(실측 2026-08-08:
