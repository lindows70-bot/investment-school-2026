...
export const GICS_SECTOR_META: Record<string, SectorMeta> = {
  'Energy':                   { ko: '에너지',        icon: '⚡', color: '#f59e0b' },
  'Basic Materials':          { ko: '소재',          icon: '🧱', color: '#a78bfa' },
  'Industrials':               { ko: '산업재',        icon: '🏗️', color: '#60a5fa' },
  'Consumer Cyclical':         { ko: '자유소비재',    icon: '🛒', color: '#fb923c' },
  'Consumer Defensive':        { ko: '필수소비재',    icon: '🥫', color: '#4ade80' },
  'Healthcare':                { ko: '헬스케어',      icon: '💊', color: '#f87171' },
  'Financial Services':        { ko: '금융',          icon: '💰', color: '#facc15' },
  'Technology':                { ko: 'IT/기술',       icon: '💻', color: '#22d3ee' },
  'Communication Services':    { ko: '커뮤니케이션',  icon: '📡', color: '#e879f9' },
  'Utilities':                  { ko: '유틸리티',      icon: '🔌', color: '#34d399' },
  'Real Estate':                { ko: '부동산',        icon: '🏢', color: '#94a3b8' },
}
