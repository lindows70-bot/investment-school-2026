...
// ── 5. ③ 일정 ────────────────────────────────────────────────────────────
{
  ...
  check('배당락 설명 + 며칠 뒤', e.body === '이날 전날까지 사 둔 사람이 이번 배당을 받아요(이날 팔아도 받아요). 오늘부터 5일 뒤예요.')
  ...
  check('ETF 배당락 → 분배락 · 분배금', etfEx.title === '9/29 TIGER 미국S&P500 분배락' && etfEx.body.startsWith('이날 전날까지 사 둔 사람이 이번 분배금을 받아요(이날 팔아도 받아요).'))
