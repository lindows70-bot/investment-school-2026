...
const INVARIANTS = [
  ...
  // 2026-09-22 신설 — 같은 함정의 두 번째 얼굴. ETF 순유입이 스냅샷 **개수**로 기간을 세고 있어
  //   하루만 빠져도 '1주'가 2~3주가 된다(값은 그럴듯해 화면검증으로 안 잡힌다).
  { file: 'scripts/verify-etf-flow-window.mjs', label: 'ETF 순유입 기간 = 실제 달력 구간' },
