...
기능별 설계·결정 기록. 여기는 **"만드는 도중의 계획·미결·근거"**를 담는다.

| 어디 | 무엇 |
|---|---|
| `CLAUDE.md` | **원칙·반복 함정·현재 상태**만. 매 세션 로딩되므로 얇게 유지한다 |
| `docs/history/2026-0N.md` | **완료된 기능의 상세 기록**(무엇을 왜 그렇게 만들었나). 2026-08-03에 CLAUDE.md 433k자에서 분리 — 274개 섹션 전량 보존 |
| `docs/<기능>/` (아래) | 만드는 도중의 계획·미결·기각 근거 |
| `docs/reference/` | **정적 참조** — 린치 엔진 알고리즘(`lynch-engine.md`) · 테이블·학생·외부 소스·캐시 키(`data-model.md`). 2026-09-17 CLAUDE.md 에서 분리(486→370줄) |
