...
- [ ] 상향 이유 태깅(실적·신제품·마진·M&A) — 무료 데이터에 없음. 보류

## 전체 (4절 완료 2026-09-19)
- [ ] 1주 뒤 재확인: Vercel SEC 속도(월 09-21) · ETF 순유입 vs etf.com(09-26) · 절 4 표본이 늘 0~5곳이면 임계 완화 검토(2곳?)
- [ ] 성적 적립(내부자·리레이팅 등재일 종가 → 60거래일) — 표본 10건부터
