...
> **최종 업데이트**: 2026-07-01 — 🏭 주글라르 CAPEX 추적기(하이퍼스케일러 5사 연간 설비투자 합산 → AI 설비투자 사이클, 2025 $379B·+69%=상승기) + 📊 섹터 성적표 행 클릭→대장주 Fwd EPS 리비전(실적 뒷받침 vs 테마 펌핑 교차검증, getAnalystSignal 재사용·MSFT 0/0→na 보정) — 4계절 내비게이터 파동 3종(키친 재고·주글라르 CAPEX·콘드라티예프 메가트렌드) 완비
