...
- ⭐ **실측이 드러낸 교육 핵심**: 같은 나스닥100인데 **타겟형(486290) +2.9%p vs 데일리 전량형(494300) −11.5%p·가격 −8.4%** — 이름이 비슷해도 옵션 매도 구조가 결과를 가른다(영상도 안 짚은 부분). 영상 주장 중 "S&P500·다우존스 커버드콜은 본주와 큰 차이 없다"는 사실로 확인(+4.3%p·−0.3%p).
