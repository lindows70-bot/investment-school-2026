...
- **검증(라이브·독립 재계산)**: BTC **연율 펀딩 3.4%·30일평균 5.9%·백분위 65%·OI $6.40B·30일 +3.2% = Binance 원천 독립 재계산과 완전 일치**(소수점). 현 조정장이라 3코인 전부 neutral(저펀딩·OI froth 낮음)=현실 정합. ETH $4.18B·SOL $0.67B(−4.8% 디레버리징).
