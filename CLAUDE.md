...
> **최종 업데이트**: 2026-06-15 — 🎯 알파 헌터(가치성장↔주가수익률 괴리 산점도·저평가/거품) + 🏦 BTC 현물 ETF(순유입/유출·누적거래량) + 🌟 종목 투자 프로필 카드 + 🧭 AI 본부장 상황 인지형 처방
