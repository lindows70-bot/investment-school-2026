...
- **🗺️ 추세의 여정 교육 아코디언**(SignalReader) — SNS 'Journey of a Trend' 6단계를 우리 신호등 언어로 번역: ①②혼돈·매물대=🟡구름속(휩쏘 구간) / ③④속임수 하락→구조돌파=🟢구름상단 돌파(확인 후 진입 이유) / ⑤⑥추세=🟢 유지·붕괴=🔴 최후방어선. '유동성 스윕' 등 주관 해석은 객관 판정(EMA·구름)만 쓴다고 명시(엘리어트 거부와 동일 원칙).
